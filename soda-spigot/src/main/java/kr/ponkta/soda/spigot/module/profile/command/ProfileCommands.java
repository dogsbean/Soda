package kr.ponkta.soda.spigot.module.profile.command;
...
import kr.ponkta.soda.packet.StaffMessagePacket;
...
import kr.ponkta.soda.spigot.module.profile.menu.ChatColorMenu;
...
import kr.ponkta.soda.spigot.module.rank.meta.RankMeta;
import kr.ponkta.soda.spigot.module.server.ServerHandler;
import kr.ponkta.soda.spigot.module.server.filter.ChatFilter;
...
public class ProfileCommands {
    ...
    @Command(names = {"sc", "staffchat"}, description = "Use the staff chat", permission = "Soda.command.staffchat")
    ...
    @Command(names = {"ac", "adminchat"}, description = "Use the admin chat", permission = "Soda.command.adminchat")
    ...
    @Command(names = {"mc", "managerchat"}, description = "Use the manager chat", permission = "Soda.command.managerchat")
    ...
    @Command(names = {"helpop", "request"}, permission = "Soda.command.helpop")
    ...
    @Command(names = {"report"}, permission = "Soda.command.report")
    ...
    @Command(names = {"list"}, permission = "Soda.command.list")
    public static void executeList(CommandSender sender) {
        ...
        if(sender.hasPermission("Soda.staff")) {
    ...
    @Command(names = {"tpm", "togglemessages", "toggleprivatemessages"}, permission = "Soda.command.tpm")
    ...
    @Command(names = {"seen"}, permission = "Soda.command.seen")
    public static void executeSeen(CommandSender sender, @Parameter(name = "player") ProfileTarget profileTarget) {
        profileTarget.resolve(profile -> {
            ...
            if(!profile.isOnline() || (player != null && player.hasMetadata("modmode")) && !player.hasPermission("Soda.staff")) {
    ...
    @Command(names = {"message", "msg"}, permission = "Soda.command.message")
    public static void executeMessage(Player player, @Parameter(name = "player") Player targetPlayer, @Parameter(name = "message", wildcard = true) String message) {
        ...
        if(target.isMessagesToggled() && !player.hasPermission("Soda.message.bypass")) {
        ...
        if(filter != null) {
            ...
            Bukkit.getOnlinePlayers().stream().filter(staff -> staff.hasPermission("Soda.staff")).forEach(staff -> {
    ...
    @Command(names = {"reply", "r"}, permission = "Soda.command.message")
    ...
    @Command(names = {"permission add"}, permission = "Soda.command.permission.add")
    ...
    @Command(names = {"permission remove"}, permission = "Soda.command.permission.remove")
    ...
    @Command(names = {"permission list"}, permission = "Soda.command.permission.list")
    ...
    @Command(names = {"gamemode c", "gamemode creative", "creative", "gamemode 1", "gmc"}, permission = "Soda.command.gamemode")
    ...
    @Command(names = {"gamemode s", "gamemode survival", "survival", "gamemode 0", "gms"}, permission = "Soda.command.gamemode")
    ...
    @Command(names = {"fly"}, permission = "Soda.command.fly")
    ...
    @Command(names = {"ss", "freeze"}, permission = "Soda.command.freeze")
    ...
    @Command(names = {"invsee"}, permission = "Soda.command.invsee")
    ...
    @Command(names = {"tp", "teleport"}, permission = "Soda.command.teleport")
    ...
    @Command(names = {"tppos"}, permission = "Soda.command.tppos")
    ...
    @Command(names = {"tphere", "s"}, permission = "Soda.command.teleport.here")
    ...
    @Command(names = {"clear", "ci", "clearinventory"}, permission = "Soda.command.clear")
    ...
    @Command(names = {"stafftimeline", "timeline"}, permission = "Soda.command.timeline")
    ...
    @Command(names = {"playtime", "pt"}, permission = "Soda.command.playtime")
    ...
    @Command(names = {"togglestaff", "togglestaffchat"}, permission = "Soda.command.togglestaff")
    ...
    @Command(names = {"link", "sync", "register"}, permission = "Soda.command.register")
    ...
    @Command(names = {"resetpassword", "forgotpassword"}, permission = "Soda.command.resetpassword")
    ...
    @Command(names = {"chatcolor"}, permission = "Soda.command.chatcolor")
    public static void chatcolor(Player player) {
        new ChatColorMenu().openMenu(player);
    }

    @Command(names = {"nick", "nickname", "disguise"}, permission = "Soda.command.nick")
    ...
    @Command(names = {"realname", "whois"}, permission = "Soda.command.realname")
    ...
    @Command(names = {"say", "bc", "broadcast"}, permission = "Soda.command.say")
...
//    @Command(names = {"setpin"}, permission = "Soda.command.setpin")
...
//        }
//
//        player.setMetadata("authed", new FixedMetadataValue(Soda.getInstance(), true));
...
//    }
//
//    @Command(names = {"auth", "2fa", "pin"}, permission = "Soda.staff")
...
//                return;
//            }
//            player.setMetadata("pin_failure", new FixedMetadataValue(Soda.getInstance(), true));
//            return;
//        }
//
//        player.setMetadata("authed", new FixedMetadataValue(Soda.getInstance(), true));
//        player.removeMetadata("pin_failure", Soda.getInstance());

package kr.ponkta.soda.spigot.module.profile;
...
import kr.ponkta.soda.packet.ProfileRefreshPacket;
...
import kr.ponkta.soda.spigot.module.profile.grant.task.GrantExpiryTask;
import kr.ponkta.soda.spigot.module.profile.identity.ProfileIdentity;
import kr.ponkta.soda.spigot.module.profile.permission.PermissionHandler;
import kr.ponkta.soda.spigot.module.profile.punishment.Punishment;
import kr.ponkta.soda.spigot.module.profile.punishment.task.PunishmentCheckerTask;
import kr.ponkta.soda.spigot.module.profile.punishment.type.PunishmentType;
import kr.ponkta.soda.spigot.module.profile.task.ProfileSaveTask;
...
import kr.ponkta.soda.spigot.util.mojang.MojangUtils;
    ...
    public Optional<Profile> fetchFromDatabase(UUID uuid) {
        if(Bukkit.isPrimaryThread()) {
            Bukkit.getOnlinePlayers()
                    .stream()
                    .filter(player -> player.hasPermission("Soda.staff"))
                    .forEach(player -> {

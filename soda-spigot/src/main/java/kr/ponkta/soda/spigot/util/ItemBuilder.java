package kr.ponkta.soda.spigot.util;
...
public class ItemBuilder {
    ...
    public ItemBuilder name(String name) {
        itemMeta.setDisplayName(kr.ponkta.soda.spigot.util.Color.translate(name));
        return this;
    }

    public ItemBuilder lore(String lore) {
        this.lore.add(kr.ponkta.soda.spigot.util.Color.translate(lore));
    ...
    public ItemBuilder lore(List<String> lore) {
        ...
        for (String str : lore) {
            toReturn.add(kr.ponkta.soda.spigot.util.Color.translate(str));
        }
        this.lore = toReturn;
        return this;
    }

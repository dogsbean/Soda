package kr.ponkta.soda.spigot.module.server;

import com.elevatemc.elib.util.Pair;
import com.google.common.collect.ImmutableMap;
import kr.ponkta.soda.spigot.module.Module;
import kr.ponkta.soda.spigot.module.server.task.ServerHeartbeatTask;
import lombok.Data;
...
public class ServerHandler extends Module {
    ...
    private final Map<String, Pair<ChatColor, ChatColor>> styles = ImmutableMap.of(
            "HyperMC", new Pair<>(ChatColor.RED, ChatColor.WHITE),
            "Aqua", new Pair<>(ChatColor.DARK_AQUA, ChatColor.WHITE),
